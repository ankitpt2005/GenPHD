    ...
    <main className="auth-screen auth-login-screen">
      <section className="auth-panel auth-login-panel" aria-labelledby="signup-title">
        ...
        <section className="auth-form-panel">
          ...
          {isConfigured ? <SignInForm mode="signup" redirectPath="/dashboard" turnstileSiteKey={turnstileSiteKey ?? ""} /> : <div className="auth-setup-note"><ShieldCheck aria-hidden="true" size={18} /><p><strong>Secure sign-up is not configured.</strong> Add the Supabase public values and Turnstile site key before creating accounts.</p></div>}
